...
public class MercuryImp implements MercuryUtil{
	...
	public String dateToString2(Calendar c) {
		SimpleDateFormat format1 = new SimpleDateFormat("yyyy-MM-dd");
		String ret = format1.format(c.getTime());
		return ret;
	}
	public String stringToString(String c) {
		Calendar data = stringToDate(c);
		SimpleDateFormat format1 = new SimpleDateFormat("dd - MM - yyyy");
		String ret = format1.format(data.getTime());
		return ret;
	}
	...
	public ArrayList<EventoPrevisto> getRicerca(ArrayList<TipoEvento> tipi, String RicercaidComune, Calendar data) throws SQLException {
        ...
        // controllo sul luogo
        if(RicercaidComune != null && !RicercaidComune.equals("")) {
